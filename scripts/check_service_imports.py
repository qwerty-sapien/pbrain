...
Service paths checked:
  src/pb/sessions, src/pb/vault, src/pb/study_service.py
"""
...
def main() -> None:
    ...
    files_checked = 0
    paths_checked = 0
    for service_path_str in SERVICE_PATHS:
        ...
        files = (
            ...
            else list(service_path.rglob("*.py"))
        )
    ...
    if all_violations:
        ...
        print(
            ...
            f"across {paths_checked} service paths"
        )
