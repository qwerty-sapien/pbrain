#!/usr/bin/env python3
"""Deterministic CLI smoke runner for pbrain.
...
class CLISmokeSuite:
    """Run a deterministic pbrain smoke suite."""

    def __init__(self) -> None:
        self._tmpdir = Path(tempfile.mkdtemp(prefix="pbrain-smoke-"))
    ...
    def env(self) -> dict[str, str]:
        env = dict(os.environ)
        env["PBRAIN_CONFIG_PATH"] = str(self.config_path)
