...
"""Safe maintenance operations for updating and resetting pbrain."""
...
def repo_root() -> Path:
    """Return the repository root that contains the pbrain checkout."""
...
def inspect_update_state(root: Path | None = None) -> dict[str, Any]:
    ...
    if not git_dir.exists():
        return {
            "supported": False,
            "repo_root": str(root),
            "message": "This pbrain install is not a git checkout. Reinstall or update it through your package manager.",
        }
