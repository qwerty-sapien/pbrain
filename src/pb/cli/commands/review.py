...
from pb.llm.review import LLMClient, score_text_response, generate_followup
...
def _run_legacy_questions(repo: Repository, engine: ReviewEngine) -> None:
    ...
    if not llm_available:
        console.print("\n[dim](Text mode disabled - configure a working LLM provider first)[/]")
