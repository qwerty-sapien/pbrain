...
class LessonEngine:
    ...
    def _plan_lesson(self) -> LessonPlanDraft:
        ...
        prompt = (
            ...
            + "Create a page-based lesson plan for pbrain.\n"
    ...
    def _extension_page_draft(self, run: LessonRunRecord, *, focus: str = "") -> LessonPageDraft:
        if self.runtime.health().available:
            ...
            prompt = (
                "Create one continuation page for a cleared pbrain lesson.\n"
    ...
    def _evaluate_answer(self, *, question: LessonQuestionRecord, raw_answer: str) -> LessonEvaluationDraft:
        ...
        prompt = (
            "Evaluate this learner answer for a pbrain lesson question.\n"
    ...
    def _generate_transformed_question(
        ...
        *,
        ...
        if self.runtime.health().available:
            prompt = (
                "Create a transformed pbrain lesson question on the same underlying concept.\n"
