    ...
    *,
    ...
    try:
        ...
        prompt = (
            ...
            "- All mathematical, statistical, logical, symbolic, or formula-like text MUST use the object form and set is_latex: true\n"
            "- Use explicit LaTeX delimiters inside math-bearing text: $...$ inline, $$...$$ display; keep leading backslashes on LaTeX commands such as \\mathbb\n"
...
def export_cards_to_apkg(cards: list[dict], vault_path: Path) -> tuple[bool, Optional[Path], str]:
    ...
    try:
        ...
        return False, None, "genanki is not installed; install the `anki` extra or export CSV instead"
