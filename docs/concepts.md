...
pbrain is built around learning loops, not task lists.
...
Recall should be scoped to a term, domain, note, session, goal, or due set. pbrain intentionally avoids vault-wide card spam.
