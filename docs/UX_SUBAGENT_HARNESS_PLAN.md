...
This file describes how to run isolated pbrain UX probes. It is for development, not end-user setup.
...
- `PBRAIN_AUTO_YES=1` only when the scenario should auto-accept
...
`PBRAIN_SHELL_TEST_MODE=1` can simplify shell tests, but it should not be treated as the production UX.
